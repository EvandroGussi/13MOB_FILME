...
import com.example.evandro.app13mob.SharedPreference.SaveSharedPreference;
...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ckConectado = (CheckBox) findViewById(R.id.ckConectado);
        ...
        btEntrar.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                ...
                if (ckConectado.isChecked()) {
                    SaveSharedPreference.setUserName(LoginActivity.this, "android");
                }
